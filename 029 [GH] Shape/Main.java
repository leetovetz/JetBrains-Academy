...
/*
 * You need to define Shape (as abstract class and as an interface), which at
 * it's minimum has 2 methods defined: calculateArea() & calculatePerimeter()
 * You need to describe related Circle, Square, Rectangle, Triangle classes. The
 * program flow is: User is invited to enter string representation of particular
 * shape (use Enum to describe available types) e.g: Circle After the figure
 * type is specified user is invited to enter properties of the selected figure.
 * e.g: for Circle: radius, for Triangle: length of a, b & c sides etc. Object
